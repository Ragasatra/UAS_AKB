package com.uas.ranggasaputra.fragment;
...
import com.uas.ranggasaputra.presenter.ContactPresenter;
import com.uas.ranggasaputra.view.ContactView;
...
public class ContactFragment extends Fragment implements ContactView, View.OnClickListener {
    ...
    public void actionCall() {
        Intent i = new Intent(Intent.ACTION_DIAL, Uri.fromParts("tel","08786884131", null));
        startActivity(i);
    }

    @Override
    public void actionEmail() {
        Intent i = new Intent(Intent.ACTION_SENDTO, Uri.parse("mailto:cpion25@gmail.com"));
        startActivity(i);
    }

    @Override
    public void actionInstagram() {
        Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse("https://instagram.com/ragasatra"));
        startActivity(i);
    }

    @Override
    public void actionTwitter() {
        Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse("https://twitter.com/Unknow"));
        startActivity(i);
    }
